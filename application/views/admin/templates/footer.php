<footer class="main-footer">
    ...
    <strong>&copy; Copyright <?= date('Y') ?> to <a href="https://instagram.com/aulia_tomayahu?utm_medium=copy_link" target="blank">AULIA TOMAYAHU</a> </strong> 1900018255
  </footer>
          ...
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                ...
                <p>Will be 28 on October 22th</p>
              </div>
            </a>
          </li>
          <li>
