        ...
        <div class="box">
            <div class="box-header">
                <button class="btn btn-primary" data-toggle="modal" data-target="#tambahData">
                    <div class="fa fa-user-plus"></div> Tambah Siswa
                </button>
            </div>
            <div class="box-body">
                        ...
                        <tbody>
                            <?php foreach ($siswa->result_array() as $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('index.php/admin/siswa/delete/').$row['id'] ?>" class="btn btn-danger btn-xs tombol-yakin" data-isidata="Jika dihapus akan berpengaruh pada data yang lain!!!">
