            ...
            <form class="form-horizontal" action="<?= base_url('index.php/admin/aplikasi/update/').$row['id'] ?>" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nama" class="form-control" value="<?= $row['nama']; ?>" placeholder="Nama Sekolah" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <img src="<?= base_url('assets/logo/').$row['logo'] ?>" alt="Logo Sekolah" class="img-responsive" width="20%">
                  </div>
                </div>
              </div>
