                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('index.php/guru/riwayatabsensi/delete/'.$abs->id ) ?>" class="btn btn-danger btn-xs tombol-yakin" data-isiData="Apakah anda yakin ingin menghapus data absensi siswa ?">
...
<?php foreach ($data_absensi as $abs) { ?>
    ...
    <div class="modal-dialog" role="document">
        ...
        <form action="<?= base_url('index.php/guru/riwayatabsensi/update/').$abs->id ?>" method="POST">
