<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <button class="btn btn-danger" data-toggle="modal" data-target="#tambahData">
            <div class="fa fa-plus"></div> Tambah Tugas
        </button>
        <a href="<?= base_url('index.php/guru/mapel/detail/').$idMapel ?>" class="btn btn-danger">
                        ...
                        <div class="box-header with-border">
                            <div class="user-block">
                                ...
                                <span class="username"><?= $mtr['judul'] ?>
                                    <a href="<?= base_url('index.php/guru/tugas/delete/').$mtr['id'].'/'.$idMapel ?>" class="tombol-yakin" data-isidata="Ingin menghapus tugas ini?"><div class="label label-danger"><div class="fa fa-trash"></div></div></a>
                                    <a href="<?= base_url('index.php/guru/tugas/penilaian/').$mtr['id'] ?>"><div class="label label-success"><div class="fa fa-check"></div> Nilai</div></a>
                                </span>
